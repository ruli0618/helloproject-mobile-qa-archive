...
<div class="lightbox" id="lightbox" aria-hidden="true">
  <div class="lightbox-panel">
    ...
    <div class="lightbox-bar"><span class="lightbox-title" id="lightboxTitle"></span><button class="lightbox-close" id="lightboxClose" type="button">閉じる</button></div>
  </div>
</div>
<script>
...
function openLightbox(link){lightboxImage.src=link.href; lightboxImage.alt=link.dataset.title || ''; lightboxTitle.textContent=link.dataset.title || ''; lightbox.classList.add('open'); lightbox.setAttribute('aria-hidden','false');}
